...
- [ ] Job schema owns exactly its destinations; supplemental job accepts one category only.
...
- [ ] Retry/split ceilings; partitioned child IDs cover exactly parent slots; no duplicated content/events.
