...
**Next implementer starts here:** [Forge R1 executable blueprint](../superpowers/plans/2026-09-20-forge-r1-executable-blueprint.md). It links exact prompt defaults and downstream job/Prompt Studio contracts; do not treat the high-level design alone as executable completion criteria.

**2026-09-20 priority update (planned, not shipped):** repeated Bundle 5 failures across user-reported Gemini and GLM runs move Forge stabilization ahead of the next canon-acceptance slice. The [Forge overhaul and Prompt Studio design](../superpowers/specs/2026-09-20-forge-overhaul-and-prompt-studio.md) and [delivery plan](../superpowers/plans/2026-09-20-forge-overhaul-delivery.md) cover schema-preserving fallback, validation before publication, explicit category allocation, durable bounded jobs, refined specialist prompts, editable versioned creative profiles and the raw-idea route. Roadmap completion counts below do not increase for design work. M4 retrieval/Activation Lab, M5 card production and M6 native fidelity evidence remain separate unfinished work.
