...
**Next implementation slice:** [Forge R2–R4 handoff](../superpowers/plans/2026-09-20-forge-r2-r4-handoff.md). R1 reliability and the R2 durable specialist path cover all six logical Forge bundles. v0.70 adds a visible Stage 3 context/request preflight with honest model-capacity uncertainty, Single Request risk reporting, and missing-model blocking. The next priority is R3's versioned Prompt Studio registry and persisted application profiles, followed by project overrides, canon conflict preflight, and R4 raw-idea routing. Artifact-target descriptions are reachable in Blueprint Studio. Live provider timing, capacity, and creative quality remain unmeasured.
