...
export interface ForgeBundleDefinition{ name:string;keys:readonly string[];schema:{type:unknown;properties:Record<string,unknown>;required:readonly string[]};promptModifier:string;includeExample?:boolean }
