import type { PromptProfileV1, ResolvedPromptSnapshotV1 } from "../../contracts/prompts";
...
export function resolvePromptSnapshot(input: { profile: PromptProfileV1 | null }): ResolvedPromptSnapshotV1 {
