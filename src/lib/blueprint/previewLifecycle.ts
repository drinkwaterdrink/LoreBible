...
export function findPreparedGraphForDocument(documentId:string,summaries:Pick<PreparedProjectGraphSummary,"id"|"legacyDocumentId">[]):Pick<PreparedProjectGraphSummary,"id"|"legacyDocumentId">|undefined{return summaries.find(item=>item.legacyDocumentId===documentId);}
export function shouldOpenProjectGraphPanel(origin:"vault"|"workflow_blueprint"):boolean{return origin==="vault";}
